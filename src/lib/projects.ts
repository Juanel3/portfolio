...
export const projects: Project[] = [
  {
    ...
    color: "sky",
    image: "/clarity_imagen.png",
    imageWidth: 1920,
    imageHeight: 1440,
    gallery: [
      {
        src: "/proyectoclarity.png",
        alt: "Clarity — pantalla 1",
        width: 1920,
        height: 1440,
      },
      {
        src: "/proyectoclarity2.png",
        alt: "Clarity — pantalla 2",
        width: 1920,
        height: 1440,
      },
      {
        src: "/proyectoclarity4.png",
        alt: "Clarity — pantalla 4",
        width: 1920,
        height: 1440,
      },
      {
        src: "/proyectoclarity6.png",
